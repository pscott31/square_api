    ...
    let order = Order {
        ...
        discounts: Some(
            vec![
                ...
                .to_owned()), type_ : Some("your type".to_owned()), uid : Some("your uid"
                .to_owned()) }
            ],
        ),
        fulfillments: Some(
            vec![
                OrderFulfillment { entries : Some(vec![OrderFulfillmentFulfillmentEntry {
                line_item_uid : "your line item uid".to_owned(), metadata :
                Some(serde_json::json!({})), quantity : "your quantity".to_owned(), uid :
                Some("your uid".to_owned()) }]), line_item_application :
                ...
                Some("your expires at".to_owned()), is_curbside_pickup : Some(true), note
                : Some("your note".to_owned()), picked_up_at : Some("your picked up at"
                .to_owned()), pickup_at : Some("your pickup at".to_owned()),
                pickup_window_duration : Some("your pickup window duration".to_owned()),
                placed_at : Some("your placed at".to_owned()), prep_time_duration :
                Some("your prep time duration".to_owned()), ready_at :
                Some("your ready at".to_owned()), recipient :
                Some(OrderFulfillmentRecipient { address : Some(Address { address_line1 :
                Some("your address line 1".to_owned()), address_line2 :
                Some("your address line 2".to_owned()), address_line3 :
                Some("your address line 3".to_owned()), administrative_district_level1 :
                ...
                Some("your locality".to_owned()), postal_code : Some("your postal code"
                .to_owned()), sublocality : Some("your sublocality".to_owned()),
                sublocality2 : Some("your sublocality 2".to_owned()), sublocality3 :
                ...
                failure_reason : Some("your failure reason".to_owned()), in_progress_at :
                Some("your in progress at".to_owned()), packaged_at :
                Some("your packaged at".to_owned()), placed_at : Some("your placed at"
                .to_owned()), recipient : Some(OrderFulfillmentRecipient { address :
                Some(Address { address_line1 : Some("your address line 1".to_owned()),
                address_line2 : Some("your address line 2".to_owned()), address_line3 :
                Some("your address line 3".to_owned()), administrative_district_level1 :
                Some("your administrative district level 1".to_owned()),
                administrative_district_level2 :
                Some("your administrative district level 2".to_owned()),
        ...
        line_items: Some(
            vec![
                ...
                Some("your currency".to_owned()) }), tax_uid : "your tax uid".to_owned(),
                uid : Some("your uid".to_owned()) }]), base_price_money : Some(Money {
                amount : Some(1), currency : Some("your currency".to_owned()) }),
                catalog_object_id : Some("your catalog object id".to_owned()),
                catalog_version : Some(1), gross_sales_money : Some(Money { amount :
                Some(1), currency : Some("your currency".to_owned()) }), item_type :
                Some("your item type".to_owned()), metadata :
                Some(serde_json::json!({})), modifiers : Some(vec![OrderLineItemModifier
                ...
                .to_owned()), quantity : Some("your quantity".to_owned()),
                total_price_money : Some(Money { amount : Some(1), currency :
                Some("your currency".to_owned()) }), uid : Some("your uid".to_owned())
                }]), name : Some("your name".to_owned()), note : Some("your note"
                .to_owned()), pricing_blocklists : Some(OrderLineItemPricingBlocklists {
                blocked_discounts :
                Some(vec![OrderLineItemPricingBlocklistsBlockedDiscount {
                discount_catalog_object_id : Some("your discount catalog object id"
                .to_owned()), discount_uid : Some("your discount uid".to_owned()), uid :
                Some("your uid".to_owned()) }]), blocked_taxes :
                Some(vec![OrderLineItemPricingBlocklistsBlockedTax {
                tax_catalog_object_id : Some("your tax catalog object id".to_owned()),
                tax_uid : Some("your tax uid".to_owned()), uid : Some("your uid"
                .to_owned()) }]) }), quantity : "your quantity".to_owned(), quantity_unit
                ...
                Some("your length unit".to_owned()), time_unit : Some("your time unit"
                .to_owned()), type_ : Some("your type".to_owned()), volume_unit :
                Some("your volume unit".to_owned()), weight_unit :
                Some("your weight unit".to_owned()) }), precision : Some(1) }),
                total_discount_money : Some(Money { amount : Some(1), currency :
                Some("your currency".to_owned()) }), total_money : Some(Money { amount :
                Some(1), currency : Some("your currency".to_owned()) }), total_tax_money
                : Some(Money { amount : Some(1), currency : Some("your currency"
                .to_owned()) }), uid : Some("your uid".to_owned()), variation_name :
                Some("your variation name".to_owned()), variation_total_price_money :
                Some(Money { amount : Some(1), currency : Some("your currency"
                .to_owned()) }) }
            ],
        ),
        ...
        refunds: Some(
            vec![
                ...
                amount_money : Money { amount : Some(1), currency : Some("your currency"
                .to_owned()) }, description : Some("your description".to_owned()),
                location_id : "your location id".to_owned(), receivable_id :
                Some("your receivable id".to_owned()) }]), amount_money : Money { amount
                : Some(1), currency : Some("your currency".to_owned()) }, created_at :
        ...
        returns: Some(
            vec![
                OrderReturn { return_amounts : Some(OrderMoneyAmounts { discount_money :
                Some(Money { amount : Some(1), currency : Some("your currency"
                .to_owned()) }), service_charge_money : Some(Money { amount : Some(1),
                currency : Some("your currency".to_owned()) }), tax_money : Some(Money {
                amount : Some(1), currency : Some("your currency".to_owned()) }),
                tip_money : Some(Money { amount : Some(1), currency :
                Some("your currency".to_owned()) }), total_money : Some(Money { amount :
                Some(1), currency : Some("your currency".to_owned()) }) }),
                return_discounts : Some(vec![OrderReturnDiscount { amount_money :
                Some(Money { amount : Some(1), currency : Some("your currency"
                .to_owned()) }), applied_money : Some(Money { amount : Some(1), currency
                : Some("your currency".to_owned()) }), catalog_object_id :
                Some("your catalog object id".to_owned()), catalog_version : Some(1),
                name : Some("your name".to_owned()), percentage : Some("your percentage"
                .to_owned()), scope : Some("your scope".to_owned()), source_discount_uid
                : Some("your source discount uid".to_owned()), type_ : Some("your type"
                .to_owned()), uid : Some("your uid".to_owned()) }]), return_line_items :
                ...
                amount : Some(1), currency : Some("your currency".to_owned()) }),
                catalog_object_id : Some("your catalog object id".to_owned()),
                catalog_version : Some(1), gross_return_money : Some(Money { amount :
                Some(1), currency : Some("your currency".to_owned()) }), item_type :
                Some("your item type".to_owned()), name : Some("your name".to_owned()),
                note : Some("your note".to_owned()), quantity : "your quantity"
                .to_owned(), quantity_unit : Some(OrderQuantityUnit { catalog_object_id :
                Some("your catalog object id".to_owned()), catalog_version : Some(1),
                measurement_unit : Some(MeasurementUnit { area_unit :
                Some("your area unit".to_owned()), custom_unit :
                Some(MeasurementUnitCustom { abbreviation : "your abbreviation"
                ...
                Some("your volume unit".to_owned()), weight_unit :
                Some("your weight unit".to_owned()) }), precision : Some(1) }),
                return_modifiers : Some(vec![OrderReturnLineItemModifier {
                base_price_money : Some(Money { amount : Some(1), currency :
                Some("your currency".to_owned()) }), catalog_object_id :
                Some("your catalog object id".to_owned()), catalog_version : Some(1),
                ...
                Some("your variation name".to_owned()), variation_total_price_money :
                Some(Money { amount : Some(1), currency : Some("your currency"
                .to_owned()) }) }]), return_service_charges :
                Some(vec![OrderReturnServiceCharge { amount_money : Some(Money { amount :
                Some(1), currency : Some("your currency".to_owned()) }), applied_money :
                Some(Money { amount : Some(1), currency : Some("your currency"
                .to_owned()) }), applied_taxes : Some(vec![OrderLineItemAppliedTax {
                applied_money : Some(Money { amount : Some(1), currency :
                Some("your currency".to_owned()) }), tax_uid : "your tax uid".to_owned(),
                uid : Some("your uid".to_owned()) }]), calculation_phase :
                Some("your calculation phase".to_owned()), catalog_object_id :
                Some("your catalog object id".to_owned()), catalog_version : Some(1),
                name : Some("your name".to_owned()), percentage : Some("your percentage"
                .to_owned()), source_service_charge_uid :
                Some("your source service charge uid".to_owned()), taxable : Some(true),
                ...
                Some("your uid".to_owned()) }]), return_taxes : Some(vec![OrderReturnTax
                { applied_money : Some(Money { amount : Some(1), currency :
                Some("your currency".to_owned()) }), catalog_object_id :
                Some("your catalog object id".to_owned()), catalog_version : Some(1),
                name : Some("your name".to_owned()), percentage : Some("your percentage"
                .to_owned()), scope : Some("your scope".to_owned()), source_tax_uid :
                Some("your source tax uid".to_owned()), type_ : Some("your type"
                .to_owned()), uid : Some("your uid".to_owned()) }]), rounding_adjustment
                : Some(OrderRoundingAdjustment { amount_money : Some(Money { amount :
                Some(1), currency : Some("your currency".to_owned()) }), name :
                Some("your name".to_owned()), uid : Some("your uid".to_owned()) }),
                source_order_id : Some("your source order id".to_owned()), uid :
        ...
        service_charges: Some(
            vec![
                ...
                Some("your catalog object id".to_owned()), catalog_version : Some(1),
                metadata : Some(serde_json::json!({})), name : Some("your name"
                .to_owned()), percentage : Some("your percentage".to_owned()), taxable :
                Some(true), total_money : Some(Money { amount : Some(1), currency :
                Some("your currency".to_owned()) }), total_tax_money : Some(Money {
                amount : Some(1), currency : Some("your currency".to_owned()) }), type_ :
                Some("your type".to_owned()), uid : Some("your uid".to_owned()) }
            ],
        ),
        ...
        taxes: Some(
            vec![
                ...
                Some("your scope".to_owned()), type_ : Some("your type".to_owned()), uid
                : Some("your uid".to_owned()) }
            ],
        ),
        tenders: Some(
            vec![
                ...
                .to_owned()) }, description : Some("your description".to_owned()),
                location_id : "your location id".to_owned(), receivable_id :
                Some("your receivable id".to_owned()) }]), amount_money : Some(Money {
                amount : Some(1), currency : Some("your currency".to_owned()) }),
                card_details : Some(TenderCardDetails { card : Some(Card {
                billing_address : Some(Address { address_line1 :
                Some("your address line 1".to_owned()), address_line2 :
                Some("your address line 2".to_owned()), address_line3 :
                Some("your address line 3".to_owned()), administrative_district_level1 :
                Some("your administrative district level 1".to_owned()),
                ...
                .to_owned()), id : Some("your id".to_owned()), last4 : Some("your last 4"
                .to_owned()), merchant_id : Some("your merchant id".to_owned()),
                prepaid_type : Some("your prepaid type".to_owned()), reference_id :
                Some("your reference id".to_owned()), version : Some(1) }), entry_method
                : Some("your entry method".to_owned()), status : Some("your status"
                .to_owned()) }), cash_details : Some(TenderCashDetails {
                buyer_tendered_money : Some(Money { amount : Some(1), currency :
                Some("your currency".to_owned()) }), change_back_money : Some(Money {
                amount : Some(1), currency : Some("your currency".to_owned()) }) }),
                created_at : Some("your created at".to_owned()), customer_id :
                ...
                currency : Some("your currency".to_owned()) }), tip_money : Some(Money {
                amount : Some(1), currency : Some("your currency".to_owned()) }),
                transaction_id : Some("your transaction id".to_owned()), type_ :
                "your type".to_owned() }
            ],
        ),
