...
async fn main() {
    ...
    let vendor = Vendor {
        ...
        contacts: Some(
            vec![
                VendorContact { email_address : Some("your email address".to_owned()), id
                : Some("your id".to_owned()), name : Some("your name".to_owned()),
                ordinal : 1, phone_number : Some("your phone number".to_owned()), removed
                : Some(true) }
            ],
        ),
